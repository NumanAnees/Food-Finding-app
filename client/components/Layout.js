      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light navb">
        <Link href="/">
          <div>
            ...
            <label className="logo-label text-center">
              <span className="text-span3 text-center">Top Dish</span>
            </label>
          </div>
        </Link>
        <Link href="/user/link/create">
          <a className="nav-link text-dark font-italic text-center text-top locaction-btn">
            {" "}
            <span className="text-span4">
              <span className="font-weight-bold link-loc">&lt;</span>Submit a
              location<span className="font-weight-bold link-loc">&gt;</span>
            </span>
          </a>
        </Link>

        <button
          class="navbar-toggler MenuOutline"
          type="button"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li className="nav-item p-1">
              <Link href="/user/link/create">
                <a className="nav-link text-dark font-italic text-center text-top locaction-btn-nav">
                  {" "}
                  <span className="text-span4">
                    <span className="font-weight-bold link-loc">&lt;</span>
                    Submit a location
                    <span className="font-weight-bold link-loc">&gt;</span>
                  </span>
                </a>
            ...
            {/* {isAuth() && isAuth().role === "admin" && (
              <li className="nav-item p-1">
                <Link href="/admin">
                  <a className="nav-link text-dark  text-center text-top">
                    {" "}
                    <span className="text-span4">Admin 's Dashboard</span>
                  </a>
                </Link>
              </li>
            )}
