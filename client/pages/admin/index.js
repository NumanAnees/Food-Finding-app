          ...
          try{
            ...
            console.log("ALL links",response.data);
             ...
             if(response.data.length < 1){
              setState({ ...state,loadedLinks: response.data,error:"No Links found"});
        ...
        <div className="row">
            ...
            <div className="col-md-8">
                    <form className="form-group" onSubmit={handleSubmit}>
                        <h2 className='text-light text-span5 text-uppercase display-6'>Update <span className='text-span'>Locations</span> based on Category</h2>
                             <br />
